    ...
    if pdf is not None:
        ...
        if query:
            if is_relevant(query, text):
                ...
                prompt = f"In the PDF you uploaded Generate a concise summary of the key findings and information related to PDF content analysis and its applications. If the response includes information unrelated to PDF content analysis or its applications, please reply with 'I don't know., {query}"
